...
<body>
	...
	<h3>1. EL(Expression Language) - 표현 언어</h3>
	<p>
	...
	<!-- 개발하는 과정에서 contextPath가 바뀔 수 있으니 아래처럼 하드코딩하지 않고 contextPath로 경로를 지정해주는 것이 좋다. -->
	...
	<p>
		...
		<!-- 태그 형태로 만들어준다고 해서 브라우저에서 실행하는 것이 아닌 서버에서 처리하고 그 결과를 리턴해주는 것은 서블릿과 동일하다. -->
	</p>
	...
	<h5>3-2) JSTL Functions Library</h5>
	<p>
