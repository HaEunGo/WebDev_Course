...
<body>
	...
	setLocale 후 톰캣 서버의 Locale 정보 : ${ pageContext.response.locale } <br>
	...
	<!-- 
		pattern : 화면에 표시할 데이터의 스타일을 지정한다. #, 0 기호를 사용하여 지정하고 초과된 부분은 반올림 된다.
				  부족한 부분에 대해서는 #을 표시하지 않지만 0은 0으로 표시한다.
	-->
	#을 이용하여 출력 : <fmt:formatNumber value="1.2346" pattern="#.###" /> <br>
	0을 이용하여 출력 : <fmt:formatNumber value="1.2346" pattern="0.###" /> <br><br>
	...
	<ul>
		...
		<li>내 패턴(원하는 형태) : <fmt:formatDate value="both" pattern="yyyy-MM-dd(E) HH:mm:ss(a)" value="${ now }"/> </li>
	</ul>
