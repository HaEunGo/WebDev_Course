...
public class B_InDecrease {
	...
	public void method1() {
		...
		System.out.println("전위 연산자 적용 전 num의 값 : " + num);		// 13	
		System.out.println();
		...
		System.out.println("3회 수행 후 값 : " + num++);				// 14
		System.out.println("후위 연산자 적용 전 num의 값 : " + num);		// 15
	...
	public void method2() {
		...
		System.out.println("result : " + result);
															// 내가 생각한 값		실제 출력 
		System.out.println(num1++);							// 11				10(11)
		System.out.println((++num1) + (num2++));				// 12+21 = 33		12 + 20(21) = 32
		System.out.println((num1++) + (--num2) + (--num3));	// 13+20+29 = 62		12(13) + 20 + 29 = 61
