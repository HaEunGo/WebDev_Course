...
public class G_Triple {
	 ...
	 *  - 상항 연산자는 중첩으로 사용이 가능하지만, 가독성에 문제가 될 수 있기 때문에 상황에 따라서 적절하게 사용해야 한다.
	 * 
	 */
	...
	public void method1() {
		...
		num = scanner.nextInt();
//		result = (num > 0) ? "양수이다." : "음수이다.";		// 괄호는 넣어도 되고 안넣어도 된다. 
//		result = (num == 0) ? "0입니다." : (num > 0) ? "양수이다." : "음수이다.";
		result = (num > 0) ? "양수이다." : (num == 0) ? "0입니다." : "음수이다." ;
