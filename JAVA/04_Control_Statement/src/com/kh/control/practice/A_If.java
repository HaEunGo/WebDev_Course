...
public class A_If {
	 ...
	 *  - 조건식의 결과가 참(ture)이면 중괄호 안의 코드를 실행한다.
	...
	public void method2() {
		...
		// 뒷 자리의 첫 번째 값이 1,3 또는 2, 4이면 "잘못 입력하셨습니다." 출력
		// 예시)
		...
		if(idNum == '1' || idNum == '3') {
			System.out.printf("남자입니다.", idNum);
		}
		if(idNum == '2' || idNum == '4') {
			System.out.printf("여자입니다.", idNum);
		}
		if(idNum !='1' && idNum !='3' && idNum !='2' && idNum !='4' ) {
...
//	 *  - 조건식의 결과가 거짓(false)인 경우 "실행 코드 2" 수행한다.
//	 *  
//	 */
	
	public void method3() {
		// 사용자의 이름을 입력받아서 본인 이름이 맞는지 확인
		String name = "";
		Scanner scanner = new Scanner(System.in);
...
//		System.out.println("고하은" == "고하은");
//		System.out.println("고하은" == new String("고하은"));
//		System.out.println(name == "고하은");
	 ...
	 *  - 단, else 문이 제시되어 있을 경우 위의 조건이 모두 false가 나오게 되면 else문이 실행된다.
	 */
