...
public class B_Switch {
	 ...
	 *  - if문과 다르게 실행 코드를 실행하고 자동으로 빠져나가지 못한다.(break;(분기문)가 필요하다.)
	 * 
	 */
...
//				return;	// return 키워드 아래 코드는 수행하지 않고 실행 흐름을 메소드를 호출한 쪽으로 돌려준다
	...
	public void method2() {
		...
		switch(month) {
			...
			case 10 :
			case 12 :
				System.out.println("입력하신 월을 31일 까지입니다.");
				break;
			case 4 :
			case 6 :
			case 9 :
			case 11 :
				System.out.println("입력하신 월을 30일 까지입니다.");
				break;
			case 2 :
				System.out.println("입력하신 월을 28일 혹은 29일 까지입니다.");
				break;
		}
