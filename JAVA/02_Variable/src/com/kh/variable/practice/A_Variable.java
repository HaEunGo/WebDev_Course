...
public class A_Variable {
	...
	public void declear() {
		 ...
		 * 		자료형 변수명;
		 * 
		 * 		- 자료형은 어던 값을 저장할지, 어떤 크기의 메모리를 할당받을지에 대한 정보
		...
		// 문자형
	//		char ch; 		// 2byte의 문자를 담을 수 있는 변수를 선언한다.
//		char ch = '\u0000';	// 유니코드 형태로 초기화 (빈 문자)
		char ch = 'a';

		// 문자열
//		String name;				// 문자열을 가리킬 수 있는 참조형 변수를 선언한다.
//		String name = new String("고하은");	//문자열은 new 없이도 생성가능한 유일한 클래스다.
		String name = "고하은";	
...
//		int 1age;
		...
		// 4) 특수문자는 '_','$'만 사용이 가능하다. (특수문자는 위치 상관없이 사용가능)
		int _age;
		int $age;
//		int @age;
//		int %age;
	...
	public void overflow() {
		...
		System.out.println("Short의 표현 범위 : " + Short.MIN_VALUE + " ~ " + Short.MAX_VALUE);						System.out.println("int의 표현 범위 : " + Integer.MIN_VALUE + " ~ " + Integer.MAX_VALUE);
