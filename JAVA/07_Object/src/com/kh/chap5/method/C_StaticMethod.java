...
public class C_StaticMethod {
	...
	// 1. 매개 변수와 반환값이 없는 메소드 선언
	public static void method1() {
		System.out.println(num1 + num2);
		
//		this.num2++;		// 객체생성을 하는 게 아니기 때문에 this 키워드 사용 X
		C_StaticMethod.num2++;
	}
	
	// 2. 매개 변수가 없고 반환값이 있는 메소드 선언
	public static int method2() {
		
		return num1 + num2;
	}
	
	// 3. 매개 변수가 있고 반환값이 없는 메소드 선언
	public static void method3(String name) {
		System.out.println(name + "님의 방문을 환영합니다.");
	}
	
	// 4. 매개 변수가 있고 반환값도 있는 메소드 선언 (가변인자 여러개 받아서 출력)
