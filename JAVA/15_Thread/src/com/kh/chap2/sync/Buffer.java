...
public class Buffer {
	 ...
	 * synchronized
	 * 
	 * 	- 동기화 메소드, 동기화 블럭에 사용되는 키워드로, 메소드 선언에 synchronized 키워드를 붙인다.(인스턴스, 정적 메소드 어디든 사용이 가능하다.)
	 * 	- 동기화 메소드는 스레드가 동기화 메소드를 실행하면 동시화 메소드 전체에 즉시 락을 걸고 메소드가 종료되면 락이 풀린다.
	...
	public synchronized void setData(int data) {
		...
		this.data = data;
		this.empty = false;		// 플래그 변수도 같이 수정해줘야한다.
